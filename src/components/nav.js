const Nav = {
    render() {
        return /* html */`
        <div class="flex justify-around justify-items-center menu bg-orange-600 py-4">
          <div class="nav">
            <nav>
              <ul class="flex text-white text-base">
                <li><a class="lg:inline-flex lg:w-auto px-3 hover:text-slate-300" href="/home">Trang chủ</a></li>
